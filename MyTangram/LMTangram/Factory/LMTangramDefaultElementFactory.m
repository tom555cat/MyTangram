//
//  LMTangramDefaultElementFactory.m
//  MyTangram
//
...
#import "LMTangramDefaultElementFactory.h"
#import <objc/runtime.h>
#import "LMTangramItemModelProtocol.h"
#import "TangramDefaultItemModel.h"

@interface LMTangramDefaultElementFactory ()

@property (nonatomic, strong) NSMutableArray<NSString *> *elementForbiddenPropertyArray;

@end

@implementation LMTangramDefaultElementFactory

+ (LMTangramDefaultElementFactory*)sharedInstance
{
    static LMTangramDefaultElementFactory *_elementFactory= nil;
    static dispatch_once_t oncePredicate;
    dispatch_once(&oncePredicate, ^{
        _elementFactory = [[LMTangramDefaultElementFactory alloc] init];
    });
 ...
 */
// 重用view(cell)的时候需要用新的数据去刷新它，
// 还是调用fillObjectPropertyByObject:viewModel:去刷新它
...
{
    LMTangramDefaultElementFactory *elementFactory = [LMTangramDefaultElementFactory sharedInstance];
